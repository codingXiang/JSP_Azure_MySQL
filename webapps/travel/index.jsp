...
<%-- <jsp:useBean id = "attraction" class="com.database.attraction.Attraction" /> --%>
<%-- <jsp:useBean id="db" class="com.runoob.StudentsBean"></jsp:useBean> --%>
...
<%
  database.connectDB();
  database.query("select * from attraction order by id");
